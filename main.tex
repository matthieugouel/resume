...
\vspace*{+2mm}
\cventry{2023 - Present}{Systems Engineer}{Cloudflare}{Paris, France}{}{
\vspace*{+1mm}
\textcolor{ultramarine}{
    Now within the Network Automation team improving observability and resilience of Cloudflare's network.
}
\vspace*{+1mm}
\begin{itemize}
    \item Three-month program with Cloudflare's research team between September and December 2023. Analyzing internet \textbf{network anomalies and outages} based on multiple data sources such as traffic data, traceroute data, BGP updates, and more.
\end{itemize}}
